...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;;EAGE,sBAAsB;EACtB,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,eAAe;EACf,uBAAuB;EACvB,cAAc;EACd,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,iBAAiB;EACjB,iCAAiC;EACjC;;;;eAIa;AACf;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,mCAAmC;EACnC,eAAe;EACf,gBAAgB;EAChB,mBAAmB;EACnB,uBAAuB;EACvB,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,eAAe;EACf,mDAA6B;EAC7B,4BAA4B;EAC5B,sBAAsB;EACtB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,SAAS;EACT,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,QAAQ;EACR,mBAAmB;EACnB,uBAAuB;EACvB,qCAAqC;EACrC,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;;EAEE,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,YAAY;AACd;;AAEA;;EAEE,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,6BAA6B;EAC7B,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;;EAEE,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,eAAe;EACf,gBAAgB;EAChB,QAAQ;AACV;;AAEA;EACE,eAAe;EACf,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,SAAS;EACT,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,YAAY;EACZ,6BAA6B;EAC7B,8BAA8B;EAC9B,kBAAkB;AACpB;;AAEA;EACE,4BAA4B;EAC5B,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,eAAe;EACf,iCAAiC;AACnC;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,uBAAuB;EACvB,aAAa;EACb,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,SAAS;AACX;;AAEA;EACE,qBAAqB;EACrB,0BAA0B;EAC1B,gBAAgB;AAClB","sourcesContent":["*,\n*::after,\n*::before {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\n:root {\n  --blue: #00bbf0;\n  --light-yellow: #f8f398;\n  --red: #ff5757;\n  --green: #5be7a9;\n}\n\nbody {\n  display: grid;\n  min-height: 100vh;\n  font-family: \"Roboto\", sans-serif;\n  grid:\n    \"header header header\" auto\n    \"main main main\" 1fr\n    \"footer footer footer\" auto /\n    1fr 1fr 1fr;\n}\n\n#header {\n  grid-area: header;\n  text-align: center;\n  font-family: \"Fasthand\", sans-serif;\n  font-size: 4rem;\n  font-weight: 500;\n  letter-spacing: 1px;\n  background: var(--blue);\n  color: white;\n  padding: 20px;\n}\n\n#main {\n  grid-area: main;\n  background: url(./aurora.jpg);\n  background-repeat: no-repeat;\n  background-size: cover;\n  color: white;\n}\n\n#forecast-container {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 20px;\n  margin-top: 40px;\n}\n\n.forecast {\n  display: flex;\n  flex-direction: column;\n  gap: 5px;\n  align-items: center;\n  justify-content: center;\n  border: 1px solid var(--light-yellow);\n  border-radius: 1rem;\n  padding: 20px 10px;\n}\n\n.forecast .forecast-date {\n  font-weight: 700;\n}\n\n.forecast .forecast-max-temperature,\n.forecast .forecast-min-temperature {\n  font-size: 0.6rem;\n}\n\n#current-container {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin: 40px;\n}\n\n#left-panel,\n#right-panel {\n  letter-spacing: 2px;\n}\n\n#left-panel {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  border: 1px solid var(--blue);\n  border-radius: 2rem;\n  padding: 40px 20px;\n}\n\n#left-panel .current-condition {\n  font-size: 2.5rem;\n  font-weight: 900;\n}\n\n#left-panel .current-city,\n#left-panel .current-temperature {\n  font-size: 1.5rem;\n}\n\n#left-panel .current-date {\n  font-size: 0.9rem;\n}\n\n#left-panel .current-temperature {\n  font-weight: 900;\n}\n\n#right-panel {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n\n#right-panel .current-stat-container {\n  display: flex;\n  flex-direction: column;\n  font-size: 2rem;\n  font-weight: 900;\n  gap: 3px;\n}\n\n#right-panel .current-stat-title {\n  font-size: 1rem;\n  font-weight: 500;\n  color: var(--blue);\n}\n\n#search-container {\n  display: flex;\n  gap: 10px;\n  margin-left: 40px;\n}\n\n#search-container input {\n  outline: none;\n  border-radius: 1rem;\n  border: none;\n  transition: all 200ms ease-in;\n  border: 2px solid var(--green);\n  text-align: center;\n}\n\n#search-container input:focus {\n  border: 2px solid var(--red);\n  transform: scale(1.05);\n}\n\n#search-container input::placeholder {\n  text-align: center;\n  color: black;\n}\n\n#search-container .search-icon {\n  cursor: pointer;\n  transition: opacity 150ms ease-in;\n}\n\n#search-container .search-icon:hover {\n  opacity: 0.7;\n}\n\n#footer {\n  grid-area: footer;\n  text-align: center;\n  background: var(--blue);\n  padding: 10px;\n  color: white;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 30px;\n}\n\n#footer a {\n  text-decoration: none;\n  color: var(--light-yellow);\n  font-weight: 900;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
